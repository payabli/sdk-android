 ...
 *
 * `Content-Length` counts bytes and this reads characters. They agree for the requests the fake token server
 * answers, which are ASCII, and the value is discarded either way.
 */
