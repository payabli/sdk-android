...
sonar {
    properties {
        ...
        //
        // Scoped to the one rule in the one file. `@Suppress("LongParameterList")` was tried first
        // and the analyser does not honour it: the issue was still reported on the commit carrying
        // it, so the annotation is gone rather than left looking like it did something.
        property("sonar.issue.ignore.multicriteria", "copyMirrorsItsProperties")
